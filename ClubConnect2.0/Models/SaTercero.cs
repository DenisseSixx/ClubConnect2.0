...
public partial class SaTercero
{
    ...
    public virtual ICollection<SaBiometrium> SaBiometria { get; set; } = new List<SaBiometrium>();

    public virtual SaCliente SaCliente { get; set; } = null!;

    public virtual SaCodTipoCompra SaCodTipoCompra { get; set; } = null!;

    public virtual SaCodTipoMantenimiento SaCodTipoMantenimiento { get; set; } = null!;

    public virtual SaCodTipoMembresium SaCodTipoMembresium { get; set; } = null!;

    public virtual ICollection<SaDependiente> SaDependientes { get; set; } = new List<SaDependiente>();

    public virtual ICollection<SaFotografium> SaFotografia { get; set; } = new List<SaFotografium>();
    ...
    public virtual ICollection<SaImportePredeterminadoTercero> SaImportePredeterminadoTerceros { get; set; } = new List<SaImportePredeterminadoTercero>();
